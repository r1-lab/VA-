...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)];
   ...
   if ((event.body.toLowerCase() == "Baler bot") || (event.body.toLowerCase() == " ")) {
...
if ((event.body.toLowerCase() == "opoman korli") ||ÿ (event.body.toLowerCase() == "biyadobi koros")) {
return api.sendMessage("-    --    ,   -", threadID);
};

if ((event.body.toLowerCase() == "single") || (event.body.toLowerCase() == "")) {
return api.sendMessage("       !", threadID);
};
